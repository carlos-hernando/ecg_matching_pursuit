function[]=simulacion_MP_test(gruposenal,diccio,tipo_cal,calidad,Q)
...
switch grupo
    case 0
        ...
        for i=37:length(tline)-1
            ficheros{i-36}=tline{i};
            senales(i-36)=str2num(ficheros{i-36});
        end
...
resultado = struct('senal',{},'no_der',{},'long_signal',{},'tipo_cal',{},'calidadobj',{},...
    'Q',{},'ultimo',{},'diccio',{}, ...
    'CR',{},'prd',{},'prd1',{},'prdseg',{},'prd1seg',{},'CRseg',{}, ...
    'RMSE',{},'RMSEseg',{},'maxidif',{},'entrada',{},'salida',{},'Qfinal',{},'coeficientes',{},'atomos',{},'codifseg',{},...
    'normas',{},'medias',{});
...
for i=1:length(senales)
    ...
    if grupo==0
        ...
        for j=1:length(calidad)
            ...
            [resultado(j).CR,resultado(j).prd,resultado(j).prd1,resultado(j).prdseg,resultado(j).prd1seg,...
            resultado(j).CRseg,resultado(j).RMSE,resultado(j).RMSEseg,resultado(j).maxidif,resultado(j).entrada,resultado(j).salida,...
            resultado(j).Qfinal,resultado(j).coeficientes,resultado(j).atomos, resultado(j).codifseg, resultado(j).normas, resultado(j).medias]...
            =comp_MP_test(resultado(j).senal,resultado(j).no_der,resultado(j).long_signal,...
